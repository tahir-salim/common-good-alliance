...
function theme_scripts() {
    ...
    wp_enqueue_style( 'layout', get_template_directory_uri() . '/assets/css/all.min.css' );
    wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/assets/css/custom.min.css' );
    wp_enqueue_style( 'custom-style2', get_template_directory_uri() . '/assets/css/responsive.css' );
    // wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/WooCommerce-Custom.css' );
    wp_enqueue_style( 'theme-style', get_stylesheet_uri());  

    wp_enqueue_script( 'main-lib', get_template_directory_uri() . '/assets/js/all.min.js', array(), '1.0.0', true );
